...
- [ ] 阅读统计 —— 已读数量、月度阅读量（依赖前三个模块先积累数据，Day 4 写 PRD 时移出本期）

**本期不做**：提供书籍正文、阅读器、社交功能、付费订阅、爬取第三方书籍数据、移动 App。完整清单和理由见 [`docs/research.md` 第 6 节](docs/research.md)。

每个功能具体做什么、什么算做对，见 [`docs/PRD.md`](docs/PRD.md)（含 23 条验收标准）。
...
| Day 4 | PRD（`docs/PRD.md`），含 23 条验收标准 | 已完成 |
| Day 7 | MVP 页面 | 未开始 |
...
│   └── PRD.md          # 产品需求文档（Day 4）：三个 MVP 功能 + 23 条验收标准
└── journal/            # 每日学习打卡日志
    ├── Day-02.md
    ├── Day-03.md
    ├── Day-04.md
