...
> **本日提交**：主体内容为 **`7ec0455`**（`TECH_DESIGN.md` + `data-flow.svg` + 打卡日志 + 截图，4 files / +732）。日志里的提交号是提交完成之后回填的，因此还有一次收尾提交——与 Day 3（`f78fda7`）、Day 4（`c1f7f69`）的收尾方式一致。
